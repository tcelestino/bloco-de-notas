...
- 📝 **Bloco de Notas**: [Bear](https://bear.app/) (macOS/iOS)
- ✅ **Lista de tarefas**: [Todoist](https://todoist.com/pt-BR) (macOS/iOS/Linux)
- 📅 **Calendário**: Apple Calendar
- ☁️ **Cloud Storage**: [Google Drive](https://workspace.google.com/products/drive/) / [iCloud](https://www.icloud.com/)
- 📷 **Câmera:** Apple Camera (iOS)
- 📰 **RSS:** [NetNewsWire](https://netnewswire.com/)
- 👥 **Lista de Contato:** Apple Contact
- 🌐 **Navegador:** [Firefox](https://getfirefox.com)
...
- 📊 **Suite de escritório:** Google Workspace/Microsoft Office (faculdade)
...
- 💻 **Editor de código:** [Cursor](https://cursor.com/)
- 💬 **Terminal:** [Ghostty](https://ghostty.org/)
- 🤖 **Assistente IA:** [Claude](https://claude.ai/login) / [Gemini](https://gemini.google.com/)
...
- [2024](https://tcelestino.github.io/bloco-de-notas/2024/12/meus-apps-essenciais-em-2024/)
